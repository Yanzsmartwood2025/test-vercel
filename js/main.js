...
if (document.getElementById('hero-slideshow')) {
    ...
    if (document.getElementById('product-grid')) {
        ...
        const categories = [
            ...
            { title: 'Granitos y Mesones', video: 'assets/videos/videologo4segundos.mp4', description: 'Superficies que combinan belleza natural y resistencia para tu hogar.', link: 'granitos/', type: 'product' },
