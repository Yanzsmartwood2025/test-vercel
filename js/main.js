...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // NOTA: Se ha eliminado la lógica de `basePath`. Todas las rutas de assets ahora son root-relative (empiezan con /)
    // para funcionar consistentemente en todas las páginas.
    ...
    // Lógica específica para la página principal que no está en ferretería.
